...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('Takeaway.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('Takeaway.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('Takeaway.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.cafemenu.section[obj.sec_n].entree.push({'item': obj.item, 'price': obj.price, 'allergen': obj.allergen }); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('Takeaway.xml', result, function(err) {
